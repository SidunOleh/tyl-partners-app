    ...
    return (
        <View>
            <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0,0,256,256" width="15px" height="15px" fill-rule="nonzero">
                <G fill={color} fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none">
